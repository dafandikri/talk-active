...
- Use this workspace as the Talk-Active product repository rather than creating a second repo — it already contains the authoritative guidebook and prior concept research (2026-08-06).
...
- Treat Talk-Active as a recurring product workspace, not a product-demo page: users keep projects, rubrics, drafts, attempts, Q&A defenses, and progress across browser reloads. Marketing hero copy and scripted demo controls are explicitly rejected (2026-08-07).
...
- The current workspace was not a Git repository when the Talk-Active product work began.
